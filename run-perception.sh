...
t_feats=('bert-base-uncased' 'bert-base-cased' 'bert-base-multilingual-uncased' 'bert-base-multilingual-cased' 'avhubert-base-lrs3-iter5' 'hubert-superb' 'roberta-base' 'gpt2') 
v_feats=('vit-fer' 'faus' 'facenet512') 
a_feats=('w2v-msp' 'egemaps' 'ds')
av_feats=('avhubert-base-lrs3-iter5' 'avhubert-large-lrs3-iter5' 'avhubert-base-vox-iter5' 'avhubert-large-vox-iter5' 'avhubert-base-noise-pt-noise-ft-30h' 'avhubert-large-noise-pt-noise-ft-30h') #('avhubert-base-lrs3-iter5') # 
